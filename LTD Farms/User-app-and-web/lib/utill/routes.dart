...
class RouteHelper {
  ...
  static String getSplashRoute(BuildContext? context,
      {NotificationBody? body, RouteAction? action}) {
    String data = 'null';
    if (body != null) {
  ...
  static String getLanguageRoute(BuildContext context, String page,
          {RouteAction? action}) =>
      _navigateRoute(context, '$languageScreen?page=$page', route: action);
  static String getOnBoardingRoute(BuildContext context,
          {RouteAction? action}) =>
      _navigateRoute(context, onBoardingScreen, route: action);
  static String getWelcomeRoute(BuildContext context, {RouteAction? action}) =>
      _navigateRoute(context, welcomeScreen, route: action);
  static String getLoginRoute(BuildContext context, {RouteAction? action}) =>
      _navigateRoute(context, loginScreen, route: action);
  static String getForgetPassRoute(BuildContext context,
          {RouteAction? action}) =>
      _navigateRoute(context, forgotPassScreen, route: action);
  static String getNewPassRoute(
          BuildContext context, String userInput, String token,
          {RouteAction? action}) =>
      _navigateRoute(
          context, '$createNewPassScreen?userInput=$userInput&token=$token',
          route: action);
  static String getVerifyRoute(
    ...
    return _navigateRoute(
        context, '$verify?page=$fromPage&userInput=$data&data=$authSession',
        route: action);
  }

  static String getCreateAccountRoute(BuildContext context,
          {RouteAction? action}) =>
      _navigateRoute(context, createAccountScreen, route: action);
  static String getMainRoute(BuildContext? context, {RouteAction? action}) =>
      _navigateRoute(context, dashboard, route: action);
  static String getMaintainRoute(BuildContext context, {RouteAction? action}) =>
      _navigateRoute(context, maintain, route: action);
  static String getSendOtpScreen(BuildContext context, {RouteAction? action}) =>
      _navigateRoute(context, sendOtp, route: action);
  static String getUpdateRoute(BuildContext context, {RouteAction? action}) =>
      _navigateRoute(context, update, route: action);
  static String getDashboardRoute(BuildContext context, String page,
          {RouteAction? action}) =>
      _navigateRoute(context, '$dashboardScreen?page=$page', route: action);
  static String getProductDetailsRoute(BuildContext context, int? id,
          {RouteAction? action}) =>
      _navigateRoute(context, '$productDetails?id=$id', route: action);
  static String getProductImageRoute(BuildContext context, String images,
          {RouteAction? action}) =>
      _navigateRoute(context, '$productImages?images=$images', route: action);
  static String getSearchRoute(BuildContext context, {RouteAction? action}) =>
      _navigateRoute(context, searchScreen, route: action);
  static String getSearchResultRoute(BuildContext context,
      {SearchShortBy? shortBy, String? text, RouteAction? action}) {
    String data = '';
    if (text?.isNotEmpty ?? false) {
      List<int> encoded = utf8.encode(jsonEncode(text ?? ''));
      data = base64Encode(encoded);
    }
    return _navigateRoute(context,
        '$searchResultScreen?text=$data&short_by=${shortBy != null ? shortBy.name : ''}',
        route: action);
  }

  static String getNotificationRoute(BuildContext context,
          {RouteAction? action}) =>
      _navigateRoute(context, notificationScreen, route: action);
  static String getCategoryRoute(
      BuildContext context, CategoryModel? categoryModel,
      {int? subCategoryId, RouteAction? action}) {
    return _navigateRoute(context,
        '$categoryScreen?sub_id=${subCategoryId ?? '-1'}&id=${categoryModel?.id}',
        route: action);
  }
  ...
  static String getCheckoutRoute(
    ...
    return _navigateRoute(context,
        '$checkoutScreen?amount=$amountData&discount=$discountData&type=$type&code=$couponData&del_char=$deliveryChargeData&fr_cart=$isFromCart',
        route: action);
  }

  static String getPaymentRoute(BuildContext context,
      {String? id = '',
      String? url,
    ...
    String data = placeOrderBody != null
        ...
        : '';
    return _navigateRoute(
        context, '$paymentScreen?id=$id&uri=$uri&place_order=$data',
        route: action);
  }

  static String getOrderDetailsRoute(
      BuildContext context, int? id, OrderModel? orderModel,
      {bool? isFromTrackOrderPage,
      String? userPhoneNumber,
      RouteAction? action}) {
    String isFromTrack = (isFromTrackOrderPage ?? false) ? '1' : '0';
    String? order = (orderModel != null)
        ? base64Url.encode(utf8.encode(jsonEncode(orderModel.toJson())))
        : null;
    return _navigateRoute(context,
        '$orderDetailsScreen?id=$id&order=$order&trackOrderPage=$isFromTrack&phone=$userPhoneNumber',
        route: action);
  }

  static String getRateReviewRoute(BuildContext context, String orderId,
      DeliveryMan deliveryMan, List<OrderDetailsModel>? orderDetailsList,
      {RouteAction? action}) {
    String delivery =
        base64Url.encode(utf8.encode(jsonEncode(deliveryMan.toJson())));
    String orderDetails = base64Url.encode(utf8.encode(
        jsonEncode(orderDetailsList?.map((e) => e.toJson()).toList() ?? [])));
    return _navigateRoute(context,
        '$rateScreen?orderId=$orderId&delivery=$delivery&orderDetails=$orderDetails',
        route: action);
  }

  static String getOrderTrackingRoute(
          BuildContext context, int? id, String? phoneNumber,
          {RouteAction? action}) =>
      _navigateRoute(context,
          '$trackOrder?id=$id&phone=${Uri.encodeComponent('$phoneNumber')}',
          route: action);
  static String getProfileRoute(BuildContext context, {RouteAction? action}) =>
      _navigateRoute(context, profileScreen, route: action);
  static String getAddressRoute(BuildContext context, {RouteAction? action}) =>
      _navigateRoute(context, addressScreen, route: action);
  static String getMapRoute(BuildContext context, AddressModel addressModel,
      {RouteAction? action}) {
  ...
  static String getAddAddressRoute(BuildContext context, String page,
      String action, AddressModel addressModel,
      {RouteAction? routeAction}) {
    String data =
        base64Url.encode(utf8.encode(jsonEncode(addressModel.toJson())));
    return _navigateRoute(
        context, '$addAddressScreen?page=$page&action=$action&address=$data',
        route: routeAction);
  }

  static String getSelectLocationRoute(BuildContext context,
          {RouteAction? action}) =>
      _navigateRoute(context, selectLocationScreen, route: action);
  static String getChatRoute(BuildContext context,
      {int? orderId,
      String? userName,
      String? profileImage,
      RouteAction? action}) {
    return _navigateRoute(
        context, '$chatScreen?id=$orderId&name=$userName&image=$profileImage',
        route: action);
  }

  static String getCouponRoute(BuildContext context, {RouteAction? action}) =>
      _navigateRoute(context, couponScreen, route: action);
  static String getSupportRoute(BuildContext context, {RouteAction? action}) =>
      _navigateRoute(context, supportScreen, route: action);
  static String getTermsRoute(BuildContext context, {RouteAction? action}) =>
      _navigateRoute(context, termsScreen, route: action);
  static String getPolicyRoute(BuildContext context, {RouteAction? action}) =>
      _navigateRoute(context, policyScreen, route: action);
  static String getAboutUsRoute(BuildContext context, {RouteAction? action}) =>
      _navigateRoute(context, aboutUsScreen, route: action);
  static String getReturnPolicyRoute(BuildContext context,
          {RouteAction? action}) =>
      _navigateRoute(context, returnPolicyScreen, route: action);
  static String getCancellationPolicyRoute(BuildContext context,
          {RouteAction? action}) =>
      _navigateRoute(context, cancellationPolicyScreen, route: action);
  static String getRefundPolicyRoute(BuildContext context,
          {RouteAction? action}) =>
      _navigateRoute(context, refundPolicyScreen, route: action);
  static String getCategoryAllRoute(BuildContext context,
          {RouteAction? action}) =>
      _navigateRoute(context, categories, route: action);
  static String getFlashSaleDetailsRoute(BuildContext context,
          {RouteAction? action}) =>
      _navigateRoute(context, flashSaleDetailsScreen, route: action);
  static String getOrderListScreen(BuildContext context,
          {RouteAction? action}) =>
      _navigateRoute(context, orderListScreen, route: action);
  static String getGameScreen(BuildContext context, {RouteAction? action}) =>
      _navigateRoute(context, orderListScreen, route: action);
  static String getOrderSearchScreen(BuildContext context,
          {RouteAction? action}) =>
      _navigateRoute(context, orderSearchScreen, route: action);
  static String getOrderSuccessScreen(
          BuildContext context, String orderId, String status,
          {RouteAction? action}) =>
      _navigateRoute(
        context,
        "$orderSuccessScreen?id=$orderId&status=$status",
        route: action,
      );
  static String getOtpRegistrationScreen(
      BuildContext context, String? tempToken, String userInput,
      {String? userName,
    ...
    return _navigateRoute(
        context, '$otpRegistration?tempToken=$data&input=$input&userName=$name',
        route: action);
  }

  static String _navigateRoute(BuildContext? context, String path,
  ...
  static Widget _routeHandler(BuildContext context, Widget route,
    ...
    return splashProvider.configModel == null
        ? const SplashScreen()
        : _isMaintenance(splashProvider.configModel!)
  ...
  static final goRoutes = GoRouter(
    ...
    initialLocation: ResponsiveHelper.isMobilePhone()
        ? getSplashRoute(Get.context)
        : getMainRoute(Get.context),
    ...
    routes: [
      GoRoute(
          ...
          builder: (context, state) {
            ...
            // }
            return _routeHandler(context, const SplashScreen(),
                path: _getPath(state));
          }),
      GoRoute(
          path: languageScreen,
          ...
          builder: (context, state) => _routeHandler(
              ...
              CreateNewPasswordScreen(
                userInput: Uri.decodeComponent(
                    state.uri.queryParameters['userInput'] ?? ''),
      ...
      GoRoute(
          ...
          builder: (context, state) {
            ...
            return _routeHandler(
                ...
                VerificationScreen(
                  userInput:
                      jsonDecode(state.uri.queryParameters['userInput'] ?? ''),
      ...
      GoRoute(
          path: maintain,
          builder: (context, state) => _routeHandler(
              context, const MaintenanceScreen(),
              path: _getPath(state))),
      GoRoute(
          ...
          builder: (context, state) {
            return _routeHandler(
                ...
                ProductDetailsScreen(
                  product:
                      Product(id: int.parse(state.uri.queryParameters['id']!)),
                ),
                path: _getPath(state));
          }),
      GoRoute(
      ...
      GoRoute(
          ...
          builder: (context, state) {
            ...
            if (state.uri.queryParameters['text']?.isNotEmpty ?? false) {
              try {
                List<int> decodedBytes =
                    base64Decode(state.uri.queryParameters['text']!);
                data = jsonDecode(
                    utf8.decode(decodedBytes)); // Decode bytes to string
              } catch (e) {}
            }
            ...
            return _routeHandler(
              ...
              SearchResultScreen(
                searchString: data,
                shortBy: (shortBy?.isEmpty ?? false) || shortBy == 'null'
                    ? null
          ...
          builder: (context, state) {
            return _routeHandler(
                ...
                CategoryScreen(
                  ...
                  subCategoryId:
                      '${state.uri.queryParameters['sub_id']}' == '-1'
                          ? null
                          : int.tryParse(state.uri.queryParameters['sub_id']!),
                ),
                path: _getPath(state));
          }),
      GoRoute(
      ...
      GoRoute(
          ...
          builder: (context, state) => _routeHandler(
              context,
              PaymentScreen(
                  url: Uri.decodeComponent(utf8
                      .decode(base64Decode(state.uri.queryParameters['uri']!))),
      ...
      GoRoute(
          ...
          builder: (context, state) {
            ...
            OrderModel? order = state.uri.queryParameters['order'] != "null"
                ? OrderModel.fromJson(jsonDecode(utf8.decode(
                    base64Url.decode(state.uri.queryParameters['order']!))))
                : null;
            ...
            return _routeHandler(
              ...
              OrderDetailsScreen(
                orderId: orderId,
                orderModel: order,
                isFromTrackOrderPage:
                    state.uri.queryParameters['trackOrderPage']!.contains('1'),
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          DeliveryMan deliveryMan = DeliveryMan.fromJson(jsonDecode(utf8.decode(
              base64Url.decode(state.uri.queryParameters['delivery'] ?? ''))));
          List<OrderDetailsModel> orderDetailsList = (jsonDecode(utf8.decode(
                      base64Url.decode(
                          state.uri.queryParameters['orderDetails'] ?? '')))
                  as List)
      ...
      GoRoute(
          path: policyScreen,
          builder: (context, state) => _routeHandler(
              context, const HtmlViewerScreen(htmlType: HtmlType.privacyPolicy),
              path: _getPath(state))),
      GoRoute(
          path: aboutUsScreen,
          builder: (context, state) => _routeHandler(
              context, const HtmlViewerScreen(htmlType: HtmlType.aboutUs),
              path: _getPath(state))),
      GoRoute(
          path: returnPolicyScreen,
          builder: (context, state) => _routeHandler(
              context, const HtmlViewerScreen(htmlType: HtmlType.returnPolicy),
              path: _getPath(state))),
      GoRoute(
      ...
      GoRoute(
          ...
          builder: (context, state) => _routeHandler(
              context, const HtmlViewerScreen(htmlType: HtmlType.refundPolicy),
              path: _getPath(state))),
      GoRoute(
          path: categories,
          builder: (context, state) => _routeHandler(
              ...
              path: _getPath(state))),
      GoRoute(
          path: flashSaleDetailsScreen,
          builder: (context, state) => _routeHandler(
              context, const FlashSaleDetailsScreen(),
              path: _getPath(state))),
      GoRoute(
      ...
      GoRoute(
          ...
          builder: (context, state) => _routeHandler(
              context, const OrderSearchScreen(),
              path: _getPath(state))),
      GoRoute(
          ...
          builder: (context, state) => _routeHandler(
              ...
              OrderSuccessfulScreen(
                  orderID: state.uri.queryParameters['id'],
                  status:
                      state.uri.queryParameters['status'] == "success" ? 0 : 1),
              path: _getPath(state))),
      GoRoute(
          path: sendOtp,
          builder: (context, state) => _routeHandler(
              context, const SendOtpScreen(),
              path: _getPath(state))),
      GoRoute(
